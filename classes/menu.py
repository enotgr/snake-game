...
class Menu:
  ...
  def _draw_record(self):
    ...
    text_surf = font.render(f'HI-SCORE: {self._record}', True, self._theme['MAIN_TEXT_COLOR'])
    text_rect = text_surf.get_rect()
  ...
  def _draw_theme_name(self):
    ...
    text_surf = font.render(f'Theme: {theme_title_name}', True, self._theme['WALL_COLOR'])
